...
func AuthMiddleware(authService auth.Service, userService service.Service) gin.HandlerFunc {
...
func AuthRole(authService auth.Service, userService service.Service) gin.HandlerFunc {
	return func(c *gin.Context) {
		authHeader := c.GetHeader("Authorization")
		// fmt.Println(authHeader)
		if !strings.Contains(authHeader, "Bearer") {
